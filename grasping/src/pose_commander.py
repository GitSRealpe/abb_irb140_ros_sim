...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def go_to_pose_goal(self, pose, q):
    # Copy class variables to local variables to make the web tutorials more clear.
    # In practice, you should use thclass variables directly unless you have a good
    # reason not to.
    group = self.group
    ...
    #pose_goal.rpy.roll=0
    #pose_goal.rpy.pitch=0
    #pose_goal.rpy.yaw=0
    #print([0.5,0,0.6,0,0,0])

    #qa = tft.quaternion_from_euler(q[0], q[1], q[2])
...
def move_to_pose(pose, q):
  try:
    ...
    tutorial.go_to_pose_goal(pose, q)
    #
