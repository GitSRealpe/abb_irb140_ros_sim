...
class image_converter:
    ...
    #    rgbo = rospy.wait_for_message('/camera/rgb/image_color', Image)
        ...
        iy, ix, Dy, Dx, iy1, ix1, Dy1, Dx1 = calibracionKinect.calibracion(depthfin, rgbfin)
        #iy, ix, Dy, Dx, iy1, ix1, Dy1, Dx1 =[79, 261, 224, 340, 10, 6, 204, 320 ]
        print(xx)
	...
	#PIXEL CON VALOR MAXIMO
        ...
        punto.position.z=-y
        #print punto
        #print convert_pose(punto,"camera_link","world")
    #rospy.spin()
        cont=0
        fig = plt.figure(figsize=(10, 10))
